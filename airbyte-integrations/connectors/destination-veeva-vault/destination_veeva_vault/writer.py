...
class VeevaVaultWriter:
    """
    Data is written to VeevaVaultClient in the following format:
    ...
    Since VeevaVaultClient allows reading records with certain prefixes, we treat it more like a message queue, expecting the reader to
