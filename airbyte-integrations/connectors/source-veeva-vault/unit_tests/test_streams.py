...
import pytest
from source_veeva_vault.source import VeevaVaultStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VeevaVaultStream, "path", "v0/example_endpoint")
    mocker.patch.object(VeevaVaultStream, "primary_key", "test_primary_key")
    mocker.patch.object(VeevaVaultStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = VeevaVaultStream()
